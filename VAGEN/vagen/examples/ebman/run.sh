...
python3 -m vagen.trainer.main_ppo \
    ...
    actor_rollout_ref.rollout.top_p=0.5 \
    ...
    trainer.experiment_name='no_insert_reason_freezeVIT_no_curriculum' \
    trainer.n_gpus_per_node=4 \
    trainer.nnodes=1 \
    trainer.save_freq=50 \
    trainer.test_freq=5 \
    trainer.total_training_steps=50 \
    trainer.default_local_dir=/work/nvme/bdjz/hchen26/era-rl-multiturn-$(date +%Y%m%d_%H%M%S) \
