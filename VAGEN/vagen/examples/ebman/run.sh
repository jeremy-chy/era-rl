...
python3 -m vagen.trainer.main_ppo \
    ...
    actor_rollout_ref.model.path=era-temporary/eb_man_all_grounding_wo_relative_single_step_reasoning_success_episodes-lr1e-5-full-e1-bs-16 \
    ...
    critic.model.path=era-temporary/eb_man_all_grounding_wo_relative_single_step_reasoning_success_episodes-lr1e-5-full-e1-bs-16 \
    ...
    trainer.experiment_name='reason-train-mini48-temp03top07-test-temp001top1-lr6e7-with-dyre-w_visual_reward-no_frozen' \
    trainer.n_gpus_per_node=8 \
    trainer.nnodes=1 \
    trainer.save_freq=100 \
    +trainer.save_start=100 \
    trainer.test_freq=4 \
    +trainer.test_start=4 \
    trainer.total_training_steps=60 \
    trainer.default_local_dir=/srv/local/ry21/era-rl-ebman-reason-mini48-temp03top07-test-temp001top1-lr6e7-with-dyre-w_visual_reward-no_frozen-$(date +%Y%m%d_%H%M%S) \
    ...
    +rollout_manager.eval_only=True \
